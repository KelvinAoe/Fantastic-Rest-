...
//        buttonContinue1.titleLabel?.font = .preferredFont(forTextStyle: .largeTitle)
       ...
       counter += 10
        ...
        if minute == 1{
            ...
            isTimerRunning = false
              ...
              createPop(title: "Fourth Exercise has done", message: "Let's continue")
            }
        }
    ...
    func createPop(title:String, message:String) {
        ...
        let vc =  self.storyboard?.instantiateViewController(withIdentifier: "FiveViewControllerID")as!FiveViewController
