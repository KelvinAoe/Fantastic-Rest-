            ...
            @objc func runTimer() {
               counter += 10
                ...
                let impactFeedbackgenerator = UIImpactFeedbackGenerator(style: .heavy)
                        if minute == 1{
                            ...
                            impactFeedbackgenerator.impactOccurred()
                                   createPop(title: "Third Exercise has done", message: "Let's continue")
                                }
                ...
                func createPop(title:String, message:String) {
                    ...
                    let vc =
                        self.storyboard?.instantiateViewController(withIdentifier: "SecondViewControllerID")as!SecondViewController
